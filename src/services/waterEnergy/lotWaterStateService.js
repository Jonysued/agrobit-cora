...
async function computeLot(lot, ctx, withHistory) {
  ...
  // La curva calculada ARRANCA en la fecha de inicialización del
  // estado hídrico: no se dibuja evolución previa (la línea no se ve
  // hacia atrás del punto de partida).
